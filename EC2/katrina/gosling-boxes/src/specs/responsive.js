...
export const EX_SPEC_RESPONSIVE_SEGREGATED_AREA_CHART = {
...
export const EX_SPEC_RESPONSIVE_MULTIVEC = {
...
export const EX_SPEC_RESPONSIVE_MULTIVEC_CIRCULAR = {
    description: 'Reference: Javed et al. Graphical perception of Multiple Time Series. TVCG 2010.',
    responsiveSize: { width: false, height: true },
    xDomain: { chromosome: 'chr12', interval: [5000000, 15000000] },
    views: [
...
export const EX_SPEC_RESPONSIVE_IDEOGRAM = {
